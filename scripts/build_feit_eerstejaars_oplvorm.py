"""
build_feit_eerstejaars_oplvorm.py
Bouwt feit_eerstejaars_oplvorm vanuit p02c (eerstejaarsingeschrevenenoplvhbo.csv).
...
print("Bouwen feit_eerstejaars_oplvorm...")

df = read_stat_csv(RAW / "p02ho1ejrs" / "eerstejaarsingeschrevenenoplvhbo.csv")
...
write_parquet(df_feit, "feit_eerstejaars_oplvorm")
