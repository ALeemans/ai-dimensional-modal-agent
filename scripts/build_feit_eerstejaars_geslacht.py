"""
build_feit_eerstejaars_geslacht.py
Bouwt feit_eerstejaars_geslacht vanuit p02a (eerstejaarsingeschrevenengeslhbo.csv).

Korrel: studiejaar × gemeente × instelling × sector × geslacht
Meetwaarde: aantal_eerstejaars
...
print("Bouwen feit_eerstejaars_geslacht...")

df = read_stat_csv(RAW / "p02ho1ejrs" / "eerstejaarsingeschrevenengeslhbo.csv")
...
write_parquet(df_feit, "feit_eerstejaars_geslacht")
