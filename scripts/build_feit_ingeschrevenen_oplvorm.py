"""
build_feit_ingeschrevenen_oplvorm.py
Bouwt feit_ingeschrevenen_oplvorm vanuit p01c (ingeschrevenenoplvhbo.csv).
...
print("Bouwen feit_ingeschrevenen_oplvorm...")

# --- Brondata laden ---
df = read_stat_csv(RAW / "p01hoinges" / "ingeschrevenenoplvhbo.csv")
...
write_parquet(df_feit, "feit_ingeschrevenen_oplvorm")
